...
tspan = (0.0, 0.5)
particle_spacing = 1.0 * 10^-3 # 1 mm
...
inlet_sampled = ComplexShape(geometry; particle_spacing, density=1.0,
...
# Returns `InitialCondition`
intake_manifold_sampled = ComplexShape(geometry; particle_spacing, density=1.0,
                                       point_in_geometry_algorithm)
...
# Returns `InitialCondition`
outlet_left_sampled = ComplexShape(geometry; particle_spacing, density=1.0,
                                   point_in_geometry_algorithm)
...
# Returns `InitialCondition`
outlet_right_sampled = ComplexShape(geometry; particle_spacing, density=1.0,
                                    point_in_geometry_algorithm)
...
n_buffer_particles = 4 * size(intake_manifold_sampled.coordinates, 2)
